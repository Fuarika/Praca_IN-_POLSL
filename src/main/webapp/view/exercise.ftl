    ...
    <div id="container">
        ...
        <div class="content">
                ...
                <#list exercises as exercise>
                    <div class="exercise">
                        <b>ZADANIE ${exercise?counter}</b> : ${exercise.contents} </br>
                            ...
                            <button id= "buttonShow_${exercise.result.id}" type="submit" onclick="myFunction('answer_${exercise.result.id}')" hidden ="true">Pokaż rozwiązanie</button>
